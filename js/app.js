...
var KATEGORI = {
    pemasukan: ['💰 給料 (Gaji)', '🎉 ボーナス (Bonus)', '💼 副業 (Freelance)', '📈 投資収入 (Investasi)', '🎁 贈り物 (Hadiah)', '📦 その他 (Lainnya)'],
    pengeluaran: ['🍱 食費 (Makanan)', '🚃 交通費 (Transportasi)', '🛍️ 買い物 (Belanja)', '🎮 娯楽 (Hiburan)', '📱 通信費 (Komunikasi)', '🏠 家賃 (Sewa)', '💡 光熱費 (Utilitas)', '🏥 医療費 (Kesehatan)', '📚 教育 (Pendidikan)', '👔 衣服 (Pakaian)', '💄 美容 (Kecantikan)', '🐾 ペット (Hewan)', '💳 保険 (Asuransi)', '💰 貯金 (Tabungan)', '📊 投資 (Investasi)', '💸 借金返済 (Bayar Hutang)', '🚨 緊急資金 (Dana Darurat)', '📦 その他 (Lainnya)']
};

var SUB_KATEGORI = {
    '🍱 食費 (Makanan)': ['🍚 米 (Beras)', '🥩 肉 (Daging)', '🐟 魚 (Ikan)', '🥬 野菜 (Sayuran)', '🍜 ラーメン (Ramen)', '🍣 寿司 (Sushi)', '🍱 弁当 (Bento)', '🍛 カレー (Kari)', '🍽️ 昼食 (Makan Siang)', '🌙 夕食 (Makan Malam)', '🍡 おやつ (Cemilan)', '🧃 飲み物 (Minuman)'],
    '🚃 交通費 (Transportasi)': ['🚃 電車 (Kereta)', '🚌 バス (Bus)', '🚕 タクシー (Taksi)', '⛽ ガソリン (Bensin)', '🅿️ 駐車場 (Parkir)', '🎫 Suica/PASMO'],
    '🛍️ 買い物 (Belanja)': ['💻 パソコン (Komputer)', '📱 スマホ (Smartphone)', '🎮 ゲーム (Game)', '📺 テレビ (TV)', '👔 衣服 (Pakaian)'],
    '🎮 娯楽 (Hiburan)': ['🎬 映画 (Bioskop)', '🎵 カラオケ (Karaoke)', '📺 動画配信 (Streaming)', '🍺 飲み会 (Nomikai)'],
    '📱 通信費 (Komunikasi)': ['📞 携帯代 (Pulsa)', '🌐 インターネット (Internet)'],
    '💡 光熱費 (Utilitas)': ['⚡ 電気代 (Listrik)', '💧 水道代 (Air)', '🔥 ガス代 (Gas)'],
    '💸 借金返済 (Bayar Hutang)': ['🏦 銀行返済 (Bank)', '💳 カード返済 (Kartu Kredit)'],
    '🚨 緊急資金 (Dana Darurat)': ['🏥 医療緊急 (Medis)', '🔧 修理緊急 (Perbaikan)']
};
...
function getSubIcon(s) {
    if (!s) return '';
    var icons = {
        '米':'🍚','Beras':'🍚','肉':'🥩','Daging':'🥩','魚':'🐟','Ikan':'🐟',
        '野菜':'🥬','Sayur':'🥬','ラーメン':'🍜','Ramen':'🍜','寿司':'🍣','Sushi':'🍣',
        '弁当':'🍱','Bento':'🍱','カレー':'🍛','Kari':'🍛','昼食':'🍽️','Siang':'🍽️',
        '夕食':'🌙','Malam':'🌙','菓子':'🍡','Cemilan':'🍡','飲み物':'🧃','Minuman':'🧃',
        '電車':'🚃','Kereta':'🚃','バス':'🚌','Bus':'🚌','タクシー':'🚕','Taksi':'🚕',
        'ガソリン':'⛽','Bensin':'⛽','駐車場':'🅿️','Parkir':'🅿️',
        'Suica':'🎫','PASMO':'🎫','パソコン':'💻','Komputer':'💻',
        'スマホ':'📱','Smartphone':'📱','ゲーム':'🎮','Game':'🎮',
        'テレビ':'📺','TV':'📺','映画':'🎬','Bioskop':'🎬',
        'カラオケ':'🎵','Karaoke':'🎵','配信':'📺','Streaming':'📺',
        '飲み会':'🍺','Nomikai':'🍺','携帯':'📞','Pulsa':'📞',
        'インターネット':'🌐','Internet':'🌐','電気':'⚡','Listrik':'⚡',
        '水道':'💧','Air':'💧','ガス':'🔥','Gas':'🔥',
        '銀行':'🏦','Bank':'🏦','カード':'💳','Kartu':'💳',
        '医療':'🏥','Medis':'🏥','修理':'🔧','Perbaikan':'🔧'
    };
    for (var key in icons) {
